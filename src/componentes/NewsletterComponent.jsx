...
export default function Newsletter() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://apifeeagri-production.up.railway.app/newsletter/subscribe/news', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        setStatus({ type: 'error', message: data.message || 'Erro ao se inscrever' });
      }
    } catch (error) {
  ...
  return (
    <div className='Newsletter'>
      <div className='container'>
        <h2>Inscreva-se na nossa Newsletter! <img src={leaf} alt="Folha decorativa" /></h2>
